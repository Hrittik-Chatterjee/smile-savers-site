---
name: Smile Savers Elite
description: Master agentic skill for the Smile Savers project. Enforces 'Council of Experts' standards for Astro 6, Tailwind 4, and Edge-Native excellence.
---

# Smile Savers Elite: Master Agent Skill

This skill centralizes the project's "System Conscience", ensuring every AI action meets the 2026 "Zero-Legacy" standards for the Smile Savers dental platform.
...
- **Compliance Officer (Legal & A11y):**
  - HIPAA-safe data patterns (public info only).
