...
description: Fetch up-to-date library documentation for Astro, Tailwind CSS, TypeScript, and other Smile Savers project dependencies using Context7 MCP
---
...
## Smile Savers Project Libraries
...
| :--- | :--- | :--- |
| **@astrojs/tailwind** | `/withastro/astro` | Tailwind integration |
...
## Common Prompts for Smile Savers
...
## Integration with Smile Savers Mobile UI Skill
...
- ✅ Smile Savers design patterns from the skill
