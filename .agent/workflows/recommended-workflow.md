---
description: Recommended AI Agent workflow for Smile Savers development
---

# Recommended Agent Workflow

This workflow outlines the optimal process for using the AI Agent system on the Smile Savers project.
